// Server side uses `rxmq` to handle subscription.
// It might be a large dependency to add, so using their topic handling
// utility for now...
//
// For More Info:
//   https://github.com/rxmqjs/rxmq.js/blob/master/src/utils/compareTopics.js
